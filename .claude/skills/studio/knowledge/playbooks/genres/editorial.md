...
The canonical Studio voice. Pages built for content-led briefs: portfolios, manifestos, type specimens, agency sites, magazine pieces, indie podcasts, bakery / brand stories, considered B2C marketing.

This is what Studio looks like when no other genre signal fires. It is the silent default.
...
`Editorial`, `Salon`, `Newsprint`, `Almanac`, `Atelier`, `Garden`, `Linen`, `Specimen`, `Studio`, `Riso`, `Sport`, `Brutal`, `Manifesto` — thirteen themes, plenty of variety inside the genre, spanning quiet print (Salon, Linen) to loud poster (Brutal, Sport, Manifesto). Canonical membership + per-theme tokens: [`themes.md`](../../rules/themes.md).
...
```css
/* Studio · genre: editorial · macrostructure: <name> · theme: <name> · enrichment: <tier> · nav: <N#> · footer: <Ft#> */
```
