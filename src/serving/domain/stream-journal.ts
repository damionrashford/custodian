import type { Result, RunId, SealedContent } from "@custodian/primitives";
 ...
 * compute twice (implementation-plan.txt:114).
 */
 ...
 * (implementation-plan.txt:116). Set on every streaming route.
 */
