 ...
 * (data-protection-and-retention.txt:52-54); sealing satisfies it by construction, so destroying a
...
export interface ResponseCache {
   ...
   * answer for forty minutes after the rollback (reliability-and-operations.txt:116-117).
   */
