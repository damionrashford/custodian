---
name: graphify
description: "Use for questions about this codebase's architecture, file relationships, or dependency structure when graphify-out/ exists — treat the question as a graphify query first. Turns any input (code, docs, papers, images, videos) into a persistent knowledge graph with god nodes, community detection, and query/path/explain tools. Not for what the platform specification says (use the research skill for .research/*.txt) or Playwright test authoring."
argument-hint: "[path|url] [--update] [--obsidian] | query \"<question>\" | explain <concept> | path <a> <b> | add <url>"
---
