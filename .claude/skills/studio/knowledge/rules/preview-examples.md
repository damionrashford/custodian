...
Four sample pick-statement blocks for the model to imitate, varied across macrostructure types — the plain-text "Genre: X. Macrostructure: Y. Theme: Z." statement SKILL.md STEP 2 requires before any code. Load this file only when picking an unusual macrostructure or custom theme and STEP 2's one-line format doesn't give enough scaffolding on its own. Most builds don't need to read this file.
