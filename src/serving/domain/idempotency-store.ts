import type { Namespace, Result, SealedContent } from "@custodian/primitives";
 ...
 * (@custodian/knowledge `namespaceFor`). A store keyed by request hash alone leaves whether
