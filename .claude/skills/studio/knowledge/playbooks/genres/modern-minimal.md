...
`Quiet` (canonical), `Coral`, `Violet`. Anything monochrome or near-monochrome with a restrained sans display and pill CTAs belongs here. Canonical membership + per-theme tokens: [`themes.md`](../../rules/themes.md).
...
```css
/* Studio · genre: modern-minimal · macrostructure: <name> · theme: <name> · enrichment: <tier> · nav: <N#> · footer: <Ft#> */
```
