...
`Bloom` (canonical), `Midnight`, `Terminal`, `Aurora`, `Halo`. Five dark-paper themes; the rotation walks them when atmospheric is active. Canonical membership + per-theme tokens: [`themes.md`](../../rules/themes.md).
...
```css
/* Studio · genre: atmospheric · macrostructure: <name> · theme: <name> · enrichment: <tier> · nav: <N#> · footer: <Ft#> */
```
