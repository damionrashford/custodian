...
Every Studio output must render flawlessly at **320 px, 375 px, 414 px, and 768 px** CSS-pixel widths. Eyeball each viewport before marking the output complete:
...
This is gate **59** in [`slop-test.md`](../playbooks/slop-test.md). Audit any output that ships interactive affordances and confirm none wrap at the breakpoints listed above.
