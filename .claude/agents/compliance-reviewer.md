...
You are reviewing a diff against `.claude/rules/compliance-and-data.md` (condensed from `Data_Protection_and_Retention.txt` and `Compliance_and_Certification.txt`).
