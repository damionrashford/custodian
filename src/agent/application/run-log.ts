import { err, ok, type Result, type SealedContent, type ToolName } from "@custodian/primitives";
import { appendEntry, type ExecutionEvent } from "@custodian/evidence";
import type { BlockedChunk } from "../domain/retrieval-rail";
