import type { ErasureProof, KeyStoreFailure, Result } from "@custodian/domain-primitives";
import type { SubjectKeyStore } from "@custodian/crypto-shred";
import { bucketFor, expiresAtForDuration, isDueForDisposal } from "@custodian/retention";
